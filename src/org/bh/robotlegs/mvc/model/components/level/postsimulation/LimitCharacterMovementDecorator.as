package org.bh.robotlegs.mvc.model.components.level.postsimulation
{
	...
	public class LimitCharacterMovementDecorator extends PostSimulationDecorator
	{
		...
		public function LimitCharacterMovementDecorator(tDecoratedPostSimulation:IPostSimulation, tAvatarsCharacterBean:CharacterBean, tMinX:int, tMinY:int, tMaxX:int, tMaxY)
		{
