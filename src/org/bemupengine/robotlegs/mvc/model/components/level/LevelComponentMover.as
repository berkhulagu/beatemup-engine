package org.bemupengine.robotlegs.mvc.model.components.level
{
	...
	{
		private var componentsToBeMoved : Vector.<DisplayObject>;
		// all components that will be moved
		private var indexOfComponentToBeMoved : int = 0;
		// next component to be moved
		private var _moveLimit : int ;
		// max number of times these components will be moved
