package org.bemupengine.robotlegs.mvc.model
{
	...
	import org.bemupengine.robotlegs.mvc.model.components.statemachine.StateMachine;
				...
				for each (var tStateXML:XML in tStateMachineXML.state)
				{
					...
					for each (var tBehavioursXML:XML in tStateXML.behaviours)
					{
						...
						for (var i : int = 0; i < tBehaviourXMLList.length(); ++i)
						{
							...
							else if (tBehaviourName == "walkLimit")
							{
							...
							else if (tBehaviourName == "addcharacter")
							{
							...
							else if (tBehaviourName == "updatecharacterstate")
							{
							...
							else if (tBehaviourName == "setconversation")
							{
							...
							else if (tBehaviourName == "addconversationlistener")
							{
							...
							else if (tBehaviourName == "dealdamage")
							{
